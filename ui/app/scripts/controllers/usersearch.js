...
angular.module('uiApp')
  .controller('UsersearchCtrl', ['UserSearchService', 'ReplyErrorHandler', 'ConfirmModal', 'notifications','$scope', function(UserSearchService, ReplyErrorHandler, ConfirmModal, notifications, $scope, $stateParams) {
