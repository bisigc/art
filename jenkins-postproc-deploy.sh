...
CMD="nohup $INSTALLPATH/bin/$APPNAME -mem $MAXMEM -J-server -Dpidfile.path=$PIDFILEPATH -Dplay.http.context=/$APPNAME/ -Dhttp.port=$SRVPORT -Dapplication.home=$INSTALLPATH"
